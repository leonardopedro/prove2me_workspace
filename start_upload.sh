...
# Always compile locally before upload.  PROVE2ME_SKIP_LOCAL_COMPILE=1
# disables the local gate only when the toolchain is genuinely unavailable.
export PROVE2ME_SKIP_LOCAL_COMPILE=0
