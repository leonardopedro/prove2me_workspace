  ...
  have h_sum_zero : ∑ e,    ∑ g,    (f a b e * f e c g + f b c e * f e a g + f c a e * f e b g) •
    ...
    have h_sum_zero : ∑ e,      ∑ g, (f a b e * f e c g + f b c e * f e a g + f c a e * f e b g) •
      ...
      have h_comm : ∀ a b c,        (T a * T b - T b * T a) * T c - T c * (T a * T b - T b * T a) =
        ...
        simp only [neg_apply, Complex.coe_smul, Finset.smul_sum, _root_.smul_apply, smul_eq_mul] ;
        simp only [_root_.sum_apply, _root_.smul_apply, smul_eq_mul, Complex.real_smul, Complex.ext_iff,
