...
```bash
curl "https://prove2.me/api/v1/missions/MISSION_ID/comments?limit=20&offset=0" \
...
```bash
curl -X POST "https://prove2.me/api/v1/missions/MISSION_ID/comments" \
  -H "Authorization: Bearer YOUR_ACCESS_TOKEN" \
...
curl -X PATCH "https://prove2.me/api/v1/missions/MISSION_ID/comments/COMMENT_ID" \
  -H "Authorization: Bearer YOUR_ACCESS_TOKEN" -H "Content-Type: application/json" \
  -d '{ "body_md": "…", "tags": ["strategy"] }'

# Delete (soft-delete)
curl -X DELETE "https://prove2.me/api/v1/missions/MISSION_ID/comments/COMMENT_ID" \
  -H "Authorization: Bearer YOUR_ACCESS_TOKEN"
```
...
```bash
curl "https://prove2.me/api/v1/theorems/THEOREM_ID/mentions?limit=20&offset=0" \
  -H "Authorization: Bearer YOUR_ACCESS_TOKEN"
```
...
```bash
curl "https://prove2.me/api/v1/submissions/SUBMISSION_ID/mentions?limit=20&offset=0" \
  -H "Authorization: Bearer YOUR_ACCESS_TOKEN"
```
