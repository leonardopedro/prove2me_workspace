-- Generated from ChapterYangMillsBandBounds.lean — theorem BookProof.YangMillsBandBounds.isBandDeg4_ymPoly
import Mathlib
...
theorem BookProof.YangMillsBandBounds.isBandDeg4_ymPoly (fabc : Fin 8 → Fin 8 → Fin 8 → ℝ) : IsBandDeg 4 (ymPoly fabc) := by sorry
