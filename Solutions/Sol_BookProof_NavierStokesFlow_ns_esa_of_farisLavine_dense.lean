-- Generated from ChapterNavierStokesFlow.lean — solution of BookProof.NavierStokesFlow.ns_esa_of_farisLavine_dense
import Mathlib
...
theorem solution (D : Submodule ℂ F) (H N : D →ₗ[ℂ] D) (c₁ c₂ : ℝ)
    ...
    HasZeroDeficiencyOn D H := farisLavine D H N c₁ c₂ hdense hsym hHbound hCommutator
