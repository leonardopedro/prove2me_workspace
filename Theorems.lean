import Theorems.Thm_Amat_herm
import Theorems.Thm_approxU_commute_resCLM
import Theorems.Thm_Bmat_herm
import Theorems.Thm_bohr_cahen_algebraic_tail_bound
...
import Theorems.Thm_BookProof_BandEnclosure_fock_mass_gap_of_nested_ritz_bands
...
import Theorems.Thm_BookProof_BandEnclosure_shiftInvert_band_enclosure
import Theorems.Thm_BookProof_BandEnclosure_shiftInvert_widths_tendsto_zero
import Theorems.Thm_BookProof_BandEnclosure_sirk_band_enclosure
...
import Theorems.Thm_BookProof_BddBelowFiberSumEsa_fiberSumHam_single
import Theorems.Thm_BookProof_BddBelowFiberSumEsa_fiberSumHam_stone_flow
import Theorems.Thm_BookProof_BddBelowFiberSumEsa_fiberSumHam_symmetricOn
import Theorems.Thm_BookProof_BddBelowFiberSumEsa_qgFiberSum_esa
import Theorems.Thm_BookProof_BddBelowFiberSumEsa_qgFiberSum_nonneg_form
...
import Theorems.Thm_BookProof_ChapterBaryonAsymmetry_matterRadiationRatio_strictMonoOn
import Theorems.Thm_BookProof_ChapterBaryonAsymmetry_matterRadiationRatio_tendsto_atTop
import Theorems.Thm_BookProof_ChapterBaryonAsymmetry_matter_satisfies_continuity
import Theorems.Thm_BookProof_ChapterBaryonAsymmetry_radiation_satisfies_continuity
import Theorems.Thm_BookProof_ChapterH1_duhamel_phiOp1
import Theorems.Thm_BookProof_ChapterH1_eigenvalue_mem_numericalRange
import Theorems.Thm_BookProof_ChapterH1_phi_at_zero
import Theorems.Thm_BookProof_ChapterH1_phi_one
import Theorems.Thm_BookProof_ChapterH1_phi_succ_apply
import Theorems.Thm_BookProof_ChapterH1_phi_succ_mul
import Theorems.Thm_BookProof_ChapterH1_phi_zero
import Theorems.Thm_BookProof_ChapterH1_phi_zero_apply
import Theorems.Thm_BookProof_ChapterH1_psi_resolvent
import Theorems.Thm_BookProof_ChapterH1_resolvent_eigenvector
import Theorems.Thm_BookProof_ChapterH1_resolvent_identity
import Theorems.Thm_BookProof_ChapterH1_resolvent_shift_mul
import Theorems.Thm_BookProof_ChapterH1_resolvent_shift_repr
...
import Theorems.Thm_BookProof_ChapterH4_psi_shift_eq_phi
import Theorems.Thm_BookProof_ChapterH4_sia_error_bound
import Theorems.Thm_BookProof_ChapterH4_sirk_error_bound
import Theorems.Thm_BookProof_ChapterH4_sirk_error_bound_decay
import Theorems.Thm_BookProof_ChapterH4_sirk_le_sia
...
import Theorems.Thm_BookProof_ChapterH9_compress_nonneg
import Theorems.Thm_BookProof_ChapterH9_compress_re_inner_mem_Icc
import Theorems.Thm_BookProof_ChapterH9_convexHull_numRange_compress_mono
...
import Theorems.Thm_BookProof_ChapterH9_mem_numRange_iff
...
import Theorems.Thm_BookProof_ChapterH9_numRange_compress_chain
...
import Theorems.Thm_BookProof_ChapterH9_numRange_compress_subset_closedBall
...
import Theorems.Thm_BookProof_ChapterH9_ritz_re_mem_Icc_of_fine
import Theorems.Thm_BookProof_ChapterH9_sirk_numRange_krylov
import Theorems.Thm_BookProof_ChapterH9_sirk_numRange_nested_orders
...
import Theorems.Thm_BookProof_ChapterH9_spectrum_compress_subset_numRange_orthonormal
import Theorems.Thm_BookProof_ChapterMajoranaProp61_gsq_Hsq_comm
import Theorems.Thm_BookProof_ChapterMajoranaProp61_prop61_isUnit
...
import Theorems.Thm_BookProof_ChapterMajoranaProp76_energyMomentum_unitary
import Theorems.Thm_BookProof_ChapterMajoranaProp76_energyTransform_fourier_unitary
...
import Theorems.Thm_BookProof_ChapterParityMajoranaQuant_annih_creat_zero
import Theorems.Thm_BookProof_ChapterParityMajoranaQuant_annihProj_herm
import Theorems.Thm_BookProof_ChapterParityMajoranaQuant_annihProj_idem
import Theorems.Thm_BookProof_ChapterParityMajoranaQuant_creat_annih_zero
import Theorems.Thm_BookProof_ChapterParityMajoranaQuant_creatProj_herm
import Theorems.Thm_BookProof_ChapterParityMajoranaQuant_creatProj_idem
...
import Theorems.Thm_BookProof_ChapterParityMajoranaQuant_J_annih
import Theorems.Thm_BookProof_ChapterParityMajoranaQuant_J_creat
import Theorems.Thm_BookProof_ChapterParityMajoranaQuant_J_unitary
import Theorems.Thm_BookProof_ChapterParityMajoranaQuant_J_unitary'
import Theorems.Thm_BookProof_ChapterParityMajoranaQuant_J_unitary_prime
import Theorems.Thm_BookProof_ChapterParityMajoranaQuant_proj_add
import Theorems.Thm_BookProof_ChapterParityMajoranaQuant_stdJ_skew
import Theorems.Thm_BookProof_ChapterParityMajoranaQuant_stdJ_sq
...
import Theorems.Thm_BookProof_ChapterSirkDiffusiveDecay_isCoercive_add_algebraMap
...
import Theorems.Thm_BookProof_ChapterSirkDiffusiveDecay_norm_heatFlow_compress_apply_le
import Theorems.Thm_BookProof_ChapterSirkDiffusiveDecay_norm_heatFlow_le
import Theorems.Thm_BookProof_ChapterSirkEndToEnd_crouzeix_domain_transfer
import Theorems.Thm_BookProof_ChapterSirkEndToEnd_crouzeix_domain_uniform
import Theorems.Thm_BookProof_ChapterSirkEndToEnd_norm_sirkApprox_apply_le
import Theorems.Thm_BookProof_ChapterSirkEndToEnd_norm_sirkApprox_apply_le_of_isometry
import Theorems.Thm_BookProof_ChapterSirkEndToEnd_sirkApprox_apply
import Theorems.Thm_BookProof_ChapterSirkEndToEnd_sirkApprox_id
import Theorems.Thm_BookProof_ChapterSirkEndToEnd_sirk_end_to_end
import Theorems.Thm_BookProof_ChapterSirkEndToEnd_sirk_end_to_end_satisfiable
import Theorems.Thm_BookProof_ChapterSirkEndToEnd_sirk_error_bound_at
import Theorems.Thm_BookProof_ChapterSirkEndToEnd_sirk_flow_error_tendsto_zero
import Theorems.Thm_BookProof_ChapterSirkEndToEnd_sirk_flow_error_uniform_in_time
import Theorems.Thm_BookProof_ChapterSirkEndToEnd_sirkReconstruction_isIdempotent
import Theorems.Thm_BookProof_ChapterSirkEndToEnd_sirkReconstruction_isSelfAdjoint
...
import Theorems.Thm_BookProof_ChapterSirkGramCutoff_defect_le_sqrt_cutoff_retained
import Theorems.Thm_BookProof_ChapterSirkGramCutoff_dist_synthesis_retained_le
import Theorems.Thm_BookProof_ChapterSirkGramCutoff_exists_gramEigen
...
import Theorems.Thm_BookProof_ChapterSirkGramCutoff_range_retainedEmbedding
...
import Theorems.Thm_BookProof_ChapterSirkGramCutoff_sirk_end_to_end_truncated_cutoff
...
import Theorems.Thm_BookProof_ChapterSirkGramWhitening_compress_gram_whitening_conj
import Theorems.Thm_BookProof_ChapterSirkGramWhitening_exists_isometry_fin_range_eq_span
import Theorems.Thm_BookProof_ChapterSirkGramWhitening_exists_isometry_range_eq_span
import Theorems.Thm_BookProof_ChapterSirkGramWhitening_exists_isWhitening
import Theorems.Thm_BookProof_ChapterSirkGramWhitening_exists_whitened_isometry_onto_span
import Theorems.Thm_BookProof_ChapterSirkGramWhitening_gramMatrix_conjTranspose
...
import Theorems.Thm_BookProof_ChapterSirkGramWhitening_gramOp_nonneg
...
import Theorems.Thm_BookProof_ChapterSirkGramWhitening_isWhitening_one_of_orthonormal
import Theorems.Thm_BookProof_ChapterSirkGramWhitening_norm_defect_synthesis_le
import Theorems.Thm_BookProof_ChapterSirkGramWhitening_norm_whitened_apply
...
import Theorems.Thm_BookProof_ChapterSirkGramWhitening_sirkApprox_gram_whitening_eq
...
import Theorems.Thm_BookProof_ChapterSirkGramWhitening_whitened_apply
import Theorems.Thm_BookProof_ChapterSirkGroupTransfer_groupFlow_transfer_uniform_on_interval
import Theorems.Thm_BookProof_ChapterSirkGroupTransfer_groupFlow_zero
...
import Theorems.Thm_BookProof_ChapterSirkMultiShift_krylov_multiShift_span_eq_of_shifts
import Theorems.Thm_BookProof_ChapterSirkMultiShift_mem_seqSpan
import Theorems.Thm_BookProof_ChapterSirkMultiShift_multiShiftSeq_const
...
import Theorems.Thm_BookProof_ChapterSirkMultiShift_multiShiftSeq_zero
...
import Theorems.Thm_BookProof_ChapterSirkPerSystem_nsDiff_sirk_crouzeix_domain
...
import Theorems.Thm_BookProof_ChapterSirkRestart_restart_error_accumulation_sirk
import Theorems.Thm_BookProof_ChapterSirkRestart_restart_error_tendsto_zero
import Theorems.Thm_BookProof_ChapterSirkRitzSpectrum_abs_re_inner_le
import Theorems.Thm_BookProof_ChapterSirkRitzSpectrum_galerkin_ritz_tendsto_sInf_spectrum_of_selected
...
import Theorems.Thm_BookProof_ChapterSirkSpectralGeometry_crouzeix_domain_convexHull
...
import Theorems.Thm_BookProof_ChapterSirkSpectralGeometry_realSegment_subset_closedBall
import Theorems.Thm_BookProof_ChapterSirkSpectralGeometry_sirk_end_to_end_crouzeix_domain
import Theorems.Thm_BookProof_ChapterSirkSpectralGeometry_sirk_end_to_end_shiftInvert
import Theorems.Thm_BookProof_ChapterSirkSpectralGeometry_sirk_end_to_end_shiftInvertC
...
import Theorems.Thm_BookProof_ChapterSirkTrotterKato_galerkin_flow_tendsto
import Theorems.Thm_BookProof_ChapterSirkTrotterKato_galerkin_flow_transfer
...
import Theorems.Thm_BookProof_ChapterSirkTrotterKato_ofBounded_op
...
import Theorems.Thm_BookProof_ChapterSirkTruncation_adjoint_reconstruction_eq
import Theorems.Thm_BookProof_ChapterSirkTruncation_compress_comp
import Theorems.Thm_BookProof_ChapterSirkTruncation_isometry_comp
import Theorems.Thm_BookProof_ChapterSirkTruncation_sirk_end_to_end_truncated
import Theorems.Thm_BookProof_ChapterSirkTruncation_sirk_end_to_end_truncated_of_exact
...
import Theorems.Thm_BookProof_ChapterSirkWhitening_rangeProj_comp_self
import Theorems.Thm_BookProof_ChapterSirkWhitening_rangeProj_eq_of_range_eq
import Theorems.Thm_BookProof_ChapterSirkWhitening_rangeProj_isSelfAdjoint
import Theorems.Thm_BookProof_ChapterSirkWhitening_sirkApprox_eq_of_range_eq
import Theorems.Thm_BookProof_ChapterSirkWhitening_whiteningEquiv_isometry
import Theorems.Thm_BookProof_ChapterSirkWhitening_whiteningEquiv_left_inverse
...
import Theorems.Thm_BookProof_ChapterStoneResolvent_UnboundedSelfAdjoint_resCLM_apply
...
import Theorems.Thm_BookProof_FarisLavine_essentiallySelfAdjointOn_top_of_symmetric
import Theorems.Thm_BookProof_FarisLavine_exists_weak_graph_limit
import Theorems.Thm_BookProof_FarisLavine_hasZeroDeficiencyOn_of_farisLavine
...
import Theorems.Thm_BookProof_FarisLavine_not_farisLavine_criterion_of_relative_bound
...
import Theorems.Thm_BookProof_FockOneParticleGap_confNumber_zero
...
import Theorems.Thm_BookProof_FockOneParticleGap_dGamma_diagCol_one_particle
import Theorems.Thm_BookProof_FockOneParticleGap_dGamma_diagCol_shift
...
import Theorems.Thm_BookProof_FockOneParticleGap_fock_energy_one_particle
import Theorems.Thm_BookProof_FockOneParticleGap_fock_gap_of_one_particle_gap
...
import Theorems.Thm_BookProof_FockOneParticleGap_fock_mass_gap_of_certified_bands
...
import Theorems.Thm_BookProof_FockOneParticleGap_numberOp_vac
import Theorems.Thm_BookProof_FockOneParticleGap_one_particle_edge_ge_of_parity_certificate
import Theorems.Thm_BookProof_FockOneParticleGap_qcdG2M4_fock_gap_of_one_particle_enclosure
import Theorems.Thm_BookProof_FockOneParticleGap_qcdG2M4_lower_eq
import Theorems.Thm_BookProof_FockOneParticleGap_re_inner_dGamma_diagCol
import Theorems.Thm_BookProof_FockOneParticleGap_sInf_nonvacuumEnergies
...
import Theorems.Thm_BookProof_FockSecondQuantization_ccr_annA_annA
...
import Theorems.Thm_BookProof_FockSecondQuantization_ccr_creA_creA
...
import Theorems.Thm_BookProof_FockSecondQuantization_coe_ymOnePart
...
import Theorems.Thm_BookProof_FockSecondQuantization_support_annA
...
import Theorems.Thm_BookProof_FockSecondQuantization_toLp_apply
...
import Theorems.Thm_BookProof_FockSecondQuantization_ymFockCol_apply
import Theorems.Thm_BookProof_FockSecondQuantization_ym_fock_friedrichs_extension
import Theorems.Thm_BookProof_FockSecondQuantization_ym_fock_hashimoto_selects
...
import Theorems.Thm_BookProof_FriedrichsExtension_friedrichs_hypothesis_holds
import Theorems.Thm_BookProof_FriedrichsExtension_unbounded_friedrichs_example
import Theorems.Thm_BookProof_FriedrichsExtension_weyl_friedrichs_extension_unconditional
...
import Theorems.Thm_BookProof_GaussCoreQuadBounds_norm_pgLp_le_shiftNorm
...
import Theorems.Thm_BookProof_HashimotoShiftInvert_diagLinC_apply
...
import Theorems.Thm_BookProof_HashimotoShiftInvert_galerkinCompression_shiftInvert_tendsto
import Theorems.Thm_BookProof_HashimotoShiftInvert_galerkinResolvent_shiftInvert_tendsto
import Theorems.Thm_BookProof_HashimotoShiftInvert_hashimoto_multishift_selects_friedrichs
import Theorems.Thm_BookProof_HashimotoShiftInvert_hashimoto_multishift_unbounded_example
import Theorems.Thm_BookProof_HashimotoShiftInvert_hashimoto_shiftInvert_selects_friedrichs
import Theorems.Thm_BookProof_HashimotoShiftInvert_hashimoto_shiftInvert_unbounded_example
...
import Theorems.Thm_BookProof_HashimotoShiftInvert_IsShiftInvertC_inner_adjoint
import Theorems.Thm_BookProof_HashimotoShiftInvert_IsShiftInvertC_mem
import Theorems.Thm_BookProof_HashimotoShiftInvert_isShiftInvertC_neg_of_isShiftInvert
...
import Theorems.Thm_BookProof_HashimotoShiftInvert_IsShiftInvert_injective
...
import Theorems.Thm_BookProof_HashimotoShiftInvert_rkCompression_tendsto
...
import Theorems.Thm_BookProof_HashimotoShiftInvert_rkVec_succ
import Theorems.Thm_BookProof_HashimotoShiftInvert_rkVec_zero
...
import Theorems.Thm_BookProof_HashimotoShiftInvert_sirkDen_succ
import Theorems.Thm_BookProof_HashimotoShiftInvert_sirkDen_zero
...
import Theorems.Thm_BookProof_HermiteBand_Band_mono
...
import Theorems.Thm_BookProof_HermiteBand_g2_nonneg
...
import Theorems.Thm_BookProof_HermiteCore_natDegree_hermiteR
...
import Theorems.Thm_BookProof_HermiteGalerkin_finiteModeDomain_ne_top
import Theorems.Thm_BookProof_HermiteGalerkin_finiteModeRestrict_apply
...
import Theorems.Thm_BookProof_HermiteGalerkin_quadForm_galerkinCompression
...
import Theorems.Thm_BookProof_HermiteGalerkin_ritzInf_extension_le
...
import Theorems.Thm_BookProof_HermiteProductBasis_pderiv_hermiteFactor_other
...
import Theorems.Thm_BookProof_HermiteProductCore_pgFun_zero
...
import Theorems.Thm_BookProof_HermiteQuadraticEsa_confV_stone_flow
...
import Theorems.Thm_BookProof_HermiteQuadraticEsa_harmonic_add_linearGrowth_essentiallySelfAdjoint
import Theorems.Thm_BookProof_HermiteQuadraticEsa_harmonic_add_subquadratic_essentiallySelfAdjoint
import Theorems.Thm_BookProof_HermiteQuadraticEsa_harmonic_add_subquadratic_stone_flow
...
import Theorems.Thm_BookProof_HermiteQuadraticEsa_scaledHarmonic_essentiallySelfAdjoint
import Theorems.Thm_BookProof_HermiteQuadraticEsa_sectorHarmonicApprox_essentiallySelfAdjoint
import Theorems.Thm_BookProof_HermiteQuadraticEsa_sectorQuad_essentiallySelfAdjoint
import Theorems.Thm_BookProof_HermiteQuadraticEsa_sectorQuad_stone_flow
import Theorems.Thm_BookProof_HermiteQuadraticEsa_tendsto_starobinskyV_div_sq
...
import Theorems.Thm_BookProof_HermiteRelative_coreOp_apply'
...
import Theorems.Thm_BookProof_HermiteRelative_harmonicOsc_add_linearPotential_essentiallySelfAdjoint
import Theorems.Thm_BookProof_HermiteRelative_hermiteMvBasis_repr_quadOp
...
import Theorems.Thm_BookProof_HyperbolicQuadratic_minkowski_apply_eq_differential
...
import Theorems.Thm_BookProof_HyperbolicQuadratic_pgFun_sub
import Theorems.Thm_BookProof_HyperbolicQuadratic_pgLp_hermiteMvLp
import Theorems.Thm_BookProof_HyperbolicQuadratic_polyGaussCore_dense_L2
import Theorems.Thm_BookProof_HyperbolicQuadratic_quadOp_add_boundedPotential_essentiallySelfAdjoint
import Theorems.Thm_BookProof_HyperbolicQuadratic_quadOp_add_realBoundedPotential_essentiallySelfAdjoint
...
import Theorems.Thm_BookProof_HyperbolicQuadratic_quadOp_not_bounded
...
import Theorems.Thm_BookProof_HyperbolicQuadratic_wave_indefiniteQuadratic_essentiallySelfAdjoint
...
import Theorems.Thm_BookProof_MajoranaClifford_a_add
import Theorems.Thm_BookProof_MajoranaClifford_a_anticomm_of_orthogonal
import Theorems.Thm_BookProof_MajoranaClifford_a_anticomm_skew
import Theorems.Thm_BookProof_MajoranaClifford_a_map_selfAdjoint
import Theorems.Thm_BookProof_MajoranaClifford_a_selfAdjoint
import Theorems.Thm_BookProof_MajoranaClifford_a_smul
import Theorems.Thm_BookProof_MajoranaClifford_a_sq
import Theorems.Thm_BookProof_MajoranaClifford_a_zero
...
import Theorems.Thm_BookProof_MajoranaClifford_reverse_antihom
import Theorems.Thm_BookProof_MajoranaClifford_reverse_involutive
import Theorems.Thm_BookProof_NavierStokesFlow_ccr_field
import Theorems.Thm_BookProof_NavierStokesFlow_continuityHamiltonian_hasZeroDeficiencyOn_finiteModes
import Theorems.Thm_BookProof_NavierStokesFlow_continuityHamiltonian_mem_finiteModes
import Theorems.Thm_BookProof_NavierStokesFlow_derivativeField_momentum
import Theorems.Thm_BookProof_NavierStokesFlow_det_one_add_smul_hasDerivAt
import Theorems.Thm_BookProof_NavierStokesFlow_DifferentialL2_ann_coreState
import Theorems.Thm_BookProof_NavierStokesFlow_DifferentialL2_comm_momOp_posOp
...
import Theorems.Thm_BookProof_NavierStokesFlow_DifferentialL2_momOp_apply_eq_differential
import Theorems.Thm_BookProof_NavierStokesFlow_DifferentialL2_momOp_coe_eq_differential
...
import Theorems.Thm_BookProof_NavierStokesFlow_DifferentialL2_nsDiffH_not_bounded
import Theorems.Thm_BookProof_NavierStokesFlow_DifferentialL2_nsQuadraticDiffH_essentiallySelfAdjointOn_core
...
import Theorems.Thm_BookProof_NavierStokesFlow_DifferentialL2_sqrtTwo_real_ne_zero
...
import Theorems.Thm_BookProof_NavierStokesFlow_DiffFarisLavine_diffMu_nonneg
...
import Theorems.Thm_BookProof_NavierStokesFlow_DiffFarisLavine_nsDiffH_commForm_bound
...
import Theorems.Thm_BookProof_NavierStokesFlow_DiffFarisLavine_nsDiffH_relative_bound
...
import Theorems.Thm_BookProof_NavierStokesFlow_DiffFarisLavine_nsDiffN_quadForm_ge_norm_sq
import Theorems.Thm_BookProof_NavierStokesFlow_DiffFarisLavine_nsDiffN_symmetricOn
import Theorems.Thm_BookProof_NavierStokesFlow_DiffFarisLavine_one_le_diffMu
...
import Theorems.Thm_BookProof_NavierStokesFlow_DiffHashimoto_exists_hermiteEnum
import Theorems.Thm_BookProof_NavierStokesFlow_DiffHashimoto_exists_l2dHilbertBasisNat
...
import Theorems.Thm_BookProof_NavierStokesFlow_DiffHashimoto_nsDiffH_selfAdjoint_extension_unique
...
import Theorems.Thm_BookProof_NavierStokesFlow_DiffHashimoto_nsQuadraticDiffH_hashimoto_selects
...
import Theorems.Thm_BookProof_NavierStokesFlow_farisLavine_holds_of_everywhereDefined
...
import Theorems.Thm_BookProof_NavierStokesFlow_FarisLavineLift_commDom_apply
...
import Theorems.Thm_BookProof_NavierStokesFlow_FarisLavineLift_ComparisonData_comparison_hasZeroDeficiencyOn_of_eigenvectors
import Theorems.Thm_BookProof_NavierStokesFlow_FarisLavineLift_ComparisonData_comparison_inner_eq
import Theorems.Thm_BookProof_NavierStokesFlow_FarisLavineLift_ComparisonData_comparison_isSymmetricDom
import Theorems.Thm_BookProof_NavierStokesFlow_FarisLavineLift_ComparisonData_comparison_nonneg
...
import Theorems.Thm_BookProof_NavierStokesFlow_FarisLavineLift_diagComparison_not_bounded
...
import Theorems.Thm_BookProof_NavierStokesFlow_FarisLavineLift_norm_inner_commutator_sum_le'
import Theorems.Thm_BookProof_NavierStokesFlow_FarisLavineLift_norm_le_norm_add_id
...
import Theorems.Thm_BookProof_NavierStokesFlow_FarisLavineLift_norm_sum_le_of_pairwise
...
import Theorems.Thm_BookProof_NavierStokesFlow_FarisLavineLift_not_forall_norm_sum_le_of_pointwise
...
import Theorems.Thm_BookProof_NavierStokesFlow_farisLavine_without_symmetry_forces_trivial
import Theorems.Thm_BookProof_NavierStokesFlow_field_evaluates_to_value
import Theorems.Thm_BookProof_NavierStokesFlow_field_evaluates_to_value_diagonal
import Theorems.Thm_BookProof_NavierStokesFlow_finiteModes_dense
import Theorems.Thm_BookProof_NavierStokesFlow_finiteModes_ne_top
...
import Theorems.Thm_BookProof_NavierStokesFlow_FockOfFock_annih_vacuum
import Theorems.Thm_BookProof_NavierStokesFlow_FockOfFock_ccr_ne
import Theorems.Thm_BookProof_NavierStokesFlow_FockOfFock_ccr_same
import Theorems.Thm_BookProof_NavierStokesFlow_FockOfFock_coeffOp_coe
import Theorems.Thm_BookProof_NavierStokesFlow_FockOfFock_creat_adjoint
...
import Theorems.Thm_BookProof_NavierStokesFlow_FockOfFock_fockDom_ne_top
import Theorems.Thm_BookProof_NavierStokesFlow_FockOfFock_innerBasis_total
...
import Theorems.Thm_BookProof_NavierStokesFlow_FockOfFock_lpFiniteModes_sum_repr
import Theorems.Thm_BookProof_NavierStokesFlow_FockOfFock_norm_lpBasis
import Theorems.Thm_BookProof_NavierStokesFlow_FockOfFock_ofCoeff_coe
import Theorems.Thm_BookProof_NavierStokesFlow_FockOfFock_outerOneParticle
...
import Theorems.Thm_BookProof_NavierStokesFlow_HermiteCanonical_bracket_DS
import Theorems.Thm_BookProof_NavierStokesFlow_HermiteCanonical_canonical_essentiallySelfAdjointOn_core
...
import Theorems.Thm_BookProof_NavierStokesFlow_HermiteCanonical_comparison_eq
...
import Theorems.Thm_BookProof_NavierStokesFlow_HermiteCanonical_drift_eq
import Theorems.Thm_BookProof_NavierStokesFlow_HermiteCanonical_hamiltonian_eq
import Theorems.Thm_BookProof_NavierStokesFlow_HermiteCanonical_mkCore_coe
...
import Theorems.Thm_BookProof_NavierStokesFlow_LagrangianCanonical_comm_lagP_lagQ
import Theorems.Thm_BookProof_NavierStokesFlow_LagrangianCanonical_comm_lagP_lagQ_of_ne
...
import Theorems.Thm_BookProof_NavierStokesFlow_LagrangianCanonical_lagCanData_drive
import Theorems.Thm_BookProof_NavierStokesFlow_LagrangianCanonical_lagCan_esa
import Theorems.Thm_BookProof_NavierStokesFlow_LagrangianCanonical_lagCan_hFull_hasZeroDeficiencyOn
...
import Theorems.Thm_BookProof_NavierStokesFlow_LagrangianCanonical_lagCan_stone_flow
...
import Theorems.Thm_BookProof_NavierStokesFlow_LagrangianCanonical_lagT_not_bounded
...
import Theorems.Thm_BookProof_NavierStokesFlow_LagrangianKatoRellich_diagKR_drift_not_bounded
...
import Theorems.Thm_BookProof_NavierStokesFlow_LagrangianKatoRellich_diagKR_hFull_hasZeroDeficiencyOn
...
import Theorems.Thm_BookProof_NavierStokesFlow_LagrangianKatoRellich_hasZeroDeficiencyOn_of_lagrangian_katoRellich
...
import Theorems.Thm_BookProof_NavierStokesFlow_LagrangianKatoRellich_jacobiLag_drift_not_relativelyBounded
...
import Theorems.Thm_BookProof_NavierStokesFlow_LagrangianKatoRellich_lagrangian_selfAdjoint_extension_unique
import Theorems.Thm_BookProof_NavierStokesFlow_LagrangianKatoRellich_lagrangian_shiftInvert_selects
...
import Theorems.Thm_BookProof_NavierStokesFlow_LagrangianNS_transformed_hamiltonian_decomposition
import Theorems.Thm_BookProof_NavierStokesFlow_LagrangianNS_transformed_hamiltonian_hermitian
import Theorems.Thm_BookProof_NavierStokesFlow_LagrangianNS_viscous_posSemidef
import Theorems.Thm_BookProof_NavierStokesFlow_lagrangian_velocity
...
import Theorems.Thm_BookProof_NavierStokesFlow_momentumConstraint_preserved
...
import Theorems.Thm_BookProof_NavierStokesFlow_nsBrst_nilpotent
import Theorems.Thm_BookProof_NavierStokesFlow_nsDivergenceConstraint_resolution
import Theorems.Thm_BookProof_NavierStokesFlow_nsDivergenceConstraint_resolution_matrix
import Theorems.Thm_BookProof_NavierStokesFlow_ns_esa_of_farisLavine
...
import Theorems.Thm_BookProof_NavierStokesFlow_nsFlow_groupOnEvolved
import Theorems.Thm_BookProof_NavierStokesFlow_nsFlow_noBlowup
...
import Theorems.Thm_BookProof_NavierStokesFlow_nsFlow_zero
import Theorems.Thm_BookProof_NavierStokesFlow_nsHamiltonian_hasZeroDeficiency
import Theorems.Thm_BookProof_NavierStokesFlow_nsHamiltonian_hasZeroDeficiencyOn
import Theorems.Thm_BookProof_NavierStokesFlow_nsHamiltonian_hasZeroDeficiencyOn_of_flow
import Theorems.Thm_BookProof_NavierStokesFlow_nsHamiltonian_hermitian
import Theorems.Thm_BookProof_NavierStokesFlow_nsHamiltonian_isPolynomial
import Theorems.Thm_BookProof_NavierStokesFlow_nsHamiltonian_ne_zero_example
import Theorems.Thm_BookProof_NavierStokesFlow_NSHashimoto_ns_hashimoto_selects
import Theorems.Thm_BookProof_NavierStokesFlow_nsNumberOp_eq_secondQuant
import Theorems.Thm_BookProof_NavierStokesFlow_nsNumberOp_posSemidef
import Theorems.Thm_BookProof_NavierStokesFlow_ns_outer_degree_le_two
import Theorems.Thm_BookProof_NavierStokesFlow_nsWord_length_le_three
import Theorems.Thm_BookProof_NavierStokesFlow_restrictToTop_apply
import Theorems.Thm_BookProof_NavierStokesFlow_secondDerivativeField_momentum
import Theorems.Thm_BookProof_NavierStokesFlow_SecondQuant_fockComparison_dense
import Theorems.Thm_BookProof_NavierStokesFlow_SecondQuant_fockComparison_domain_ne_top
import Theorems.Thm_BookProof_NavierStokesFlow_SecondQuant_fockComparison_ge_norm_sq
import Theorems.Thm_BookProof_NavierStokesFlow_SecondQuant_fockComparison_hasZeroDeficiencyOn
...
import Theorems.Thm_BookProof_NavierStokesFlow_SecondQuant_fockOp_hasZeroDeficiencyOn_of_farisLavine
...
import Theorems.Thm_BookProof_NavierStokesFlow_SecondQuant_mem_fockCore
import Theorems.Thm_BookProof_NavierStokesFlow_SecondQuant_ofSectors_apply
...
import Theorems.Thm_BookProof_NavierStokesFlow_SignedShift_gaffH_essentiallySelfAdjointOn_core
import Theorems.Thm_BookProof_NavierStokesFlow_SignedShift_gaffH_symmetricOn
...
import Theorems.Thm_BookProof_NavierStokesFlow_SignedShift_listH_nil
...
import Theorems.Thm_BookProof_NavierStokesFlow_SignedShift_SignedHop_hopH_essentiallySelfAdjointOn_core
...
import Theorems.Thm_BookProof_NavierStokesFlow_SignedShift_SignedHop_maj_amp
import Theorems.Thm_BookProof_NavierStokesFlow_SignedShift_SignedHop_maj_K
import Theorems.Thm_BookProof_NavierStokesFlow_SignedShift_SignedHop_maj_shift
import Theorems.Thm_BookProof_NavierStokesFlow_SignedShift_SignedHop_maj_step
import Theorems.Thm_BookProof_NavierStokesFlow_SignedShift_SignedHop_maj_sym
...
import Theorems.Thm_BookProof_NavierStokesFlow_ThreeComponent_diagHop_amp
import Theorems.Thm_BookProof_NavierStokesFlow_ThreeComponent_diagHop_shift
...
import Theorems.Thm_BookProof_NavierStokesFlow_ThreeComponent_pairHop_amp
import Theorems.Thm_BookProof_NavierStokesFlow_ThreeComponent_pairHop_shift
import Theorems.Thm_BookProof_NavierStokesFlow_ThreeComponent_raise_apply
import Theorems.Thm_BookProof_NavierStokesFlow_ThreeComponent_rotHop_amp
import Theorems.Thm_BookProof_NavierStokesFlow_ThreeComponent_rotHop_shift
import Theorems.Thm_BookProof_NavierStokesFlow_ThreeComponent_shDiag_apply
import Theorems.Thm_BookProof_NavierStokesFlow_ThreeComponent_shearHop_amp
import Theorems.Thm_BookProof_NavierStokesFlow_ThreeComponent_shearHop_shift
...
import Theorems.Thm_BookProof_NavierStokesFlow_ThreeComponent_velH_coord_diag
...
import Theorems.Thm_BookProof_NavierStokesFlow_ThreeComponent_velH_coord_shear
import Theorems.Thm_BookProof_NavierStokesFlow_ThreeComponent_velH_domain_dense
import Theorems.Thm_BookProof_NavierStokesFlow_ThreeComponent_velH_essentiallySelfAdjointOn_core
import Theorems.Thm_BookProof_NavierStokesFlow_ThreeComponent_velH_ne_zero_of_strain
import Theorems.Thm_BookProof_NavierStokesFlow_ThreeComponent_velH_ne_zero_of_vorticity
...
import Theorems.Thm_BookProof_NavierStokesFlow_ThreeComponent_velSym_of_total
import Theorems.Thm_BookProof_NavierStokesFlow_velocityOp_mem_finiteModes
import Theorems.Thm_BookProof_NavierStokesFlow_volume_preservation_constraint
...
import Theorems.Thm_BookProof_QgHermiteCore_integral_scalaronHamiltonian_symm
...
import Theorems.Thm_BookProof_QgHermiteCore_memLp_scalaronFull1D_mul_gaussPoly
import Theorems.Thm_BookProof_QgHermiteCore_memLp_scalaronHamiltonian_gaussPoly
import Theorems.Thm_BookProof_QgHermiteCore_memLp_scalaronSectorPotential_mul_pgFun
import Theorems.Thm_BookProof_QgHermiteCore_memLp_starobinskyV_mul_gaussPoly
import Theorems.Thm_BookProof_QgHermiteCore_tendsto_exp_abs_mul_gaussH_atTop
...
import Theorems.Thm_BookProof_QgHermiteFriedrichs_coreEquiv_apply
...
import Theorems.Thm_BookProof_QgHermiteFriedrichs_qgOneParticleHermite_friedrichs
import Theorems.Thm_BookProof_QgHermiteFriedrichs_qgOneParticleSector_friedrichs
...
import Theorems.Thm_BookProof_QgHermiteOscillator_harmonic_add_bounded_essentiallySelfAdjoint
...
import Theorems.Thm_BookProof_QgHermiteOscillator_harmonicCore_stone_flow
...
import Theorems.Thm_BookProof_RitzCertificate_fock_mass_gap_of_temple_certificates
...
import Theorems.Thm_BookProof_RitzPerturbation_abs_minmaxLevelIn_sub_le_dist
import Theorems.Thm_BookProof_RitzPerturbation_abs_minmaxLevel_sub_le_dist
import Theorems.Thm_BookProof_RitzPerturbation_abs_rayleighSup_sub_le_dist
import Theorems.Thm_BookProof_RitzPerturbation_abs_rayleighVal_sub_le_dist
import Theorems.Thm_BookProof_RitzPerturbation_abs_sInf_spectrum_sub_le_dist
import Theorems.Thm_BookProof_RitzPerturbation_galerkin_model_gap_eventually_pos
import Theorems.Thm_BookProof_RitzPerturbation_galerkin_model_gap_tendsto
import Theorems.Thm_BookProof_RitzPerturbation_minmaxGap_ge_of_dist_le
import Theorems.Thm_BookProof_RitzPerturbation_minmaxGap_nonneg
import Theorems.Thm_BookProof_RitzPerturbation_minmaxGap_pos_of_dist_lt
import Theorems.Thm_BookProof_RitzPerturbation_minmaxGap_shiftOp
import Theorems.Thm_BookProof_RitzPerturbation_minmaxGap_tendsto_of_tendsto
...
import Theorems.Thm_BookProof_RitzPerturbation_minmaxLevel_le_minmaxLevelIn_add
import Theorems.Thm_BookProof_RitzPerturbation_minmaxLevel_le_norm
import Theorems.Thm_BookProof_RitzPerturbation_minmaxLevel_mono_form
...
import Theorems.Thm_BookProof_RitzPerturbation_neg_norm_le_minmaxLevel
...
import Theorems.Thm_BookProof_ScalaronEdge_edgeShelf_pos
import Theorems.Thm_BookProof_ScalaronEdge_edge_sup_sq_le
import Theorems.Thm_BookProof_ScalaronEdge_scalaronEdge_friedrichs_gap
...
import Theorems.Thm_BookProof_ScalaronEdge_starobinskyEdge_quadForm
...
import Theorems.Thm_BookProof_ScalaronEsa_mem_ccSchwartz
...
import Theorems.Thm_BookProof_ScalaronEsa_qgScalaron_stone_flow
import Theorems.Thm_BookProof_ScalaronEsa_scalaronFullPotential_essentiallySelfAdjoint
...
import Theorems.Thm_BookProof_ScalaronEsa_starobinskyV_essentiallySelfAdjoint
import Theorems.Thm_BookProof_ScalaronEsa_starobinskyV_not_hasTemperateGrowth
import Theorems.Thm_BookProof_ScalaronEsa_symmetricOn_inclusion
import Theorems.Thm_BookProof_ScalaronEsa_wave_add_scalaron_esa_of_finiteSpeed
import Theorems.Thm_BookProof_ScalaronEsa_wave_add_scalaron_symmetric
import Theorems.Thm_BookProof_ScalaronEsa_wave_add_scalaronTruncated_esa
...
import Theorems.Thm_BookProof_ScalaronFiberFL_WallPot_isGraphCore_core
...
import Theorems.Thm_BookProof_ScalaronWallEsa_starobinskyWall_stone_flow
import Theorems.Thm_BookProof_ScalaronWallEsa_testCc_apply
...
import Theorems.Thm_BookProof_ShiftedHermiteCore_pgMapT_apply
import Theorems.Thm_BookProof_ShiftedHermiteCore_phaseArg_sec
import Theorems.Thm_BookProof_ShiftedHermiteCore_phaseFun_add
...
import Theorems.Thm_BookProof_SirkBandLedger_formatExampleLedger_lo_zero
import Theorems.Thm_BookProof_SirkBandLedger_formatExampleLedger_nested
import Theorems.Thm_BookProof_SirkBandLedger_formatExampleLedger_parse
...
import Theorems.Thm_BookProof_SirkBandLedger_friedrichs_form_gap_of_ledger_lo_zero
import Theorems.Thm_BookProof_SirkBandLedger_hiQ_antitone
import Theorems.Thm_BookProof_SirkBandLedger_ledgerLo_le_ledgerHi
...
import Theorems.Thm_BookProof_SirkBandLedger_ledgerWf_order
import Theorems.Thm_BookProof_SirkBandLedger_ledgerWf_sameOp
...
import Theorems.Thm_BookProof_SirkBandLedger_ledger_width_tendsto_zero_iff
...
import Theorems.Thm_BookProof_SirkBandLedger_ritz_band_enclosure_of_ledger
import Theorems.Thm_BookProof_SirkCertificateReader_Decimal_toQ_nonneg
import Theorems.Thm_BookProof_SirkCertificateReader_formatExample_certified_gap
import Theorems.Thm_BookProof_SirkCertificateReader_formatExample_gap
import Theorems.Thm_BookProof_SirkCertificateReader_formatExample_lower
import Theorems.Thm_BookProof_SirkCertificateReader_formatExample_lower_pos
import Theorems.Thm_BookProof_SirkCertificateReader_formatExample_parse
import Theorems.Thm_BookProof_SirkCertificateReader_formatExample_width
import Theorems.Thm_BookProof_SirkCertificateReader_gap_ge_of_ndjson
import Theorems.Thm_BookProof_SirkCertificateReader_gap_pos_of_ndjson
import Theorems.Thm_BookProof_SirkCertificateReader_parseDec_example
import Theorems.Thm_BookProof_SirkCertificateReader_parseDec_int_example
import Theorems.Thm_BookProof_SirkCertificateReader_parseDec_neg_example
import Theorems.Thm_BookProof_SirkCertificateReader_parseDec_reject
import Theorems.Thm_BookProof_SirkCertificateReader_toGapCertificate_lower
import Theorems.Thm_BookProof_SirkCertifiedGap_certifiedGap_eventually_pos
import Theorems.Thm_BookProof_SirkCertifiedGap_certifiedGap_sound
...
import Theorems.Thm_BookProof_SirkCertifiedGap_certified_parity_gap_of_data
import Theorems.Thm_BookProof_SirkCertifiedGap_certified_parity_gap_pos
import Theorems.Thm_BookProof_SirkCertifiedGap_certified_parity_gap_strong_coupling
import Theorems.Thm_BookProof_SirkCertifiedGap_gap_ge_of_certificate
import Theorems.Thm_BookProof_SirkCertifiedGap_gap_pos_of_certificate
import Theorems.Thm_BookProof_SirkCertifiedGap_le_sectorGround
import Theorems.Thm_BookProof_SirkCertifiedGap_qcdG2M4_certified_gap
import Theorems.Thm_BookProof_SirkCertifiedGap_qcdG2M4_lower
import Theorems.Thm_BookProof_SirkCertifiedGap_qcdG2M4_lower_pos
import Theorems.Thm_BookProof_SirkCertifiedGap_rayleigh_odd_ge_of_certified
...
import Theorems.Thm_BookProof_SirkCertifiedGap_resolvent_mapsTo_paritySector
import Theorems.Thm_BookProof_SirkCertifiedGap_sectorGround_eq_inf_eigenvalues
import Theorems.Thm_BookProof_SirkCertifiedGap_sectorGround_ge_temple
...
import Theorems.Thm_BookProof_SirkCertifiedGap_sectorRestrict_coe
...
import Theorems.Thm_BookProof_SirkFinitePrecision_backward_error_weyl_symm
import Theorems.Thm_BookProof_SirkFinitePrecision_CertInterval_abs_le_of_isotone
import Theorems.Thm_BookProof_SirkFinitePrecision_CertInterval_abs_polyEval_le_of_mem
import Theorems.Thm_BookProof_SirkFinitePrecision_CertInterval_dist_le_width
import Theorems.Thm_BookProof_SirkFinitePrecision_CertInterval_le_sup_bound_of_isotone
...
import Theorems.Thm_BookProof_SirkFinitePrecision_CertInterval_mem_neg
import Theorems.Thm_BookProof_SirkFinitePrecision_CertInterval_mem_ofRounded
import Theorems.Thm_BookProof_SirkFinitePrecision_CertInterval_mem_sub
import Theorems.Thm_BookProof_SirkFinitePrecision_CertInterval_mem_widen
import Theorems.Thm_BookProof_SirkFinitePrecision_CertInterval_polyEval_le_of_mem
import Theorems.Thm_BookProof_SirkFinitePrecision_exists_eigenvalue_dist_le_residual
import Theorems.Thm_BookProof_SirkFinitePrecision_exists_eigenvalue_dist_le_residual_unit
import Theorems.Thm_BookProof_SirkFinitePrecision_ground_ge_of_no_eigenvalue_below
...
import Theorems.Thm_BookProof_SirkFinitePrecision_observable_propagation_band
...
import Theorems.Thm_BookProof_SirkGapTable_certified_gap_table
import Theorems.Thm_BookProof_SirkGapTable_certified_gap_table_interval
import Theorems.Thm_BookProof_SirkGapTable_CouplingCertificate_lo_le_hi
import Theorems.Thm_BookProof_SirkGapTable_gap_le_of_certificate
import Theorems.Thm_BookProof_SirkGapTable_one_lt_ratio
import Theorems.Thm_BookProof_SirkGapTable_qcdG2M4Row_lo
import Theorems.Thm_BookProof_SirkGapTable_qcdG2M4_strongCoupling_consistent
import Theorems.Thm_BookProof_SirkGapTable_richardson_error
import Theorems.Thm_BookProof_SirkGapTable_richardson_exact
import Theorems.Thm_BookProof_SirkGapTable_richardson_qym_g4
import Theorems.Thm_BookProof_SirkGapTable_richardson_qym_g4_gt
import Theorems.Thm_BookProof_SirkGapTable_strongCoupling_lt
import Theorems.Thm_BookProof_SirkGapTable_strongCoupling_mem_of_certificate
import Theorems.Thm_BookProof_SirkSingleTime_isShiftInvertC_neg_resCLM_shift
import Theorems.Thm_BookProof_SirkSingleTime_norm_neg_resCLM_apply_le
...
import Theorems.Thm_BookProof_SirkSingleTime_sirk_single_time_shiftInvert_bound
import Theorems.Thm_BookProof_SirkSingleTime_starobinsky_qgContinuum_singleTime_shiftInvert_convergence
import Theorems.Thm_BookProof_SirkSingleTime_starobinsky_qgManifold_singleTime_shiftInvert_convergence
...
import Theorems.Thm_BookProof_Starobinsky_confV_bddBelow
import Theorems.Thm_BookProof_Starobinsky_confV_completed_square
import Theorems.Thm_BookProof_Starobinsky_confV_ge
import Theorems.Thm_BookProof_Starobinsky_confV_zero_alpha_tendsto_atBot
import Theorems.Thm_BookProof_Starobinsky_fR_eq_scalarTensor
...
import Theorems.Thm_BookProof_Starobinsky_qgR2Mode_deficiencyTrivialAt
import Theorems.Thm_BookProof_Starobinsky_qgR2Mode_esa
import Theorems.Thm_BookProof_Starobinsky_qgR2Mode_potential_ge
...
import Theorems.Thm_BookProof_Starobinsky_starobinskyV_tendsto_atBot_atTop
import Theorems.Thm_BookProof_Starobinsky_starobinskyV_tendsto_plateau
import Theorems.Thm_BookProof_Starobinsky_starobinskyV_zero
...
import Theorems.Thm_BookProof_StoneBridge_unboundedSelfAdjointOf_domain
import Theorems.Thm_BookProof_StoneBridge_unboundedSelfAdjointOf_op
...
import Theorems.Thm_BookProof_WallEsaSemibounded_wallHam_nonneg_form
import Theorems.Thm_BookProof_YangMillsBandBounds_gradedBand_of_isBandR
import Theorems.Thm_BookProof_YangMillsBandBounds_isBandDeg2_magMulOp
import Theorems.Thm_BookProof_YangMillsBandBounds_isBandDeg4_ymPoly
...
import Theorems.Thm_BookProof_YangMillsBandBounds_isHermCol_ymHermCol
import Theorems.Thm_BookProof_YangMillsBandBounds_ymHamiltonian_hermCore_eq'
import Theorems.Thm_BookProof_YangMillsBandBounds_ym_hermCol_band_bounds
...
import Theorems.Thm_BookProof_YangMillsBandBounds_ymPoly_zero
import Theorems.Thm_BookProof_YangMillsBianchi_bianchi
import Theorems.Thm_BookProof_YangMillsBianchi_bianchi_cyclic
import Theorems.Thm_BookProof_YangMillsBianchi_bianchi_fieldStrength
import Theorems.Thm_BookProof_YangMillsBianchi_fieldStrength_antisymm
...
import Theorems.Thm_BookProof_YangMillsFriedrichs_friedrichs_hypothesis_satisfiable
...
import Theorems.Thm_BookProof_YangMillsFriedrichsLimit_friedrichs_bounded_proper_domain_example
...
import Theorems.Thm_BookProof_YangMillsFriedrichsLimit_topRestrict_apply
import Theorems.Thm_BookProof_YangMillsFriedrichsLimit_weyl_friedrichs_bounded
...
import Theorems.Thm_BookProof_YangMillsFriedrichs_weylForm_closable
import Theorems.Thm_BookProof_YangMillsFriedrichs_weyl_friedrichs_extension
import Theorems.Thm_BookProof_YangMillsFriedrichs_weylKrylov_bestApprox_antitone
import Theorems.Thm_BookProof_YangMillsFriedrichs_weylKrylov_bestApprox_tendsto_zero
...
import Theorems.Thm_BookProof_YangMillsGhost_ghostEnergy_nonneg
import Theorems.Thm_BookProof_YangMillsGhost_ymGhostHam_add_bounded_coupling_esa
...
import Theorems.Thm_BookProof_YangMillsGhost_ymGhostHam_preserves_ghostNumber
import Theorems.Thm_BookProof_YangMillsGhost_ymGhostHam_stone_flow
import Theorems.Thm_BookProof_YangMillsGhost_ymGhostHam_symmetricOn
import Theorems.Thm_BookProof_YangMillsGhost_ymGhostHam_vacuum_fibre
...
import Theorems.Thm_BookProof_YangMillsHermite_idxA_injective
import Theorems.Thm_BookProof_YangMillsHermite_inner_pgLp_pgLp
import Theorems.Thm_BookProof_YangMillsHermite_levi_values
...
import Theorems.Thm_BookProof_YangMillsHermite_ymHamiltonian_apply
...
import Theorems.Thm_BookProof_YangMillsHermite_ym_hermite_friedrichs_extension
...
import Theorems.Thm_BookProof_YangMillsSU3_structureConstant_totally_antisymmetric
import Theorems.Thm_cast_le_total
import Theorems.Thm_ccr_annA_annA
import Theorems.Thm_ccr_creA_creA
import Theorems.Thm_continuous_stoneU_apply
import Theorems.Thm_convex_realSegment
import Theorems.Thm_diagKR_constraint_zero
import Theorems.Thm_diagKR_drift
import Theorems.Thm_diagKR_drive
import Theorems.Thm_diagOp_zero_symbol
import Theorems.Thm_dn_dn_comm
import Theorems.Thm_drift_isSymmetricDom
import Theorems.Thm_ell2Basis_apply
import Theorems.Thm_ell2ShiftInvert_injective
import Theorems.Thm_ell2ShiftInvert_isSelfAdjoint
import Theorems.Thm_euler_partial_product_nonvanishing
import Theorems.Thm_exists_confEnum
import Theorems.Thm_exists_hermiteEnum
import Theorems.Thm_exists_velEnum
import Theorems.Thm_exists_velHilbertBasis
import Theorems.Thm_finiteOccupation_dense
import Theorems.Thm_fockConfBasis_apply
import Theorems.Thm_gaussInt_zero
import Theorems.Thm_gpow_one
import Theorems.Thm_gpow_two
import Theorems.Thm_gpow_zero
import Theorems.Thm_half_cast
import Theorems.Thm_hFull_eq_add
import Theorems.Thm_hFull_isSymmetricDom
import Theorems.Thm_hopCol_not_summable
import Theorems.Thm_inSector_zero_op
import Theorems.Thm_isBandDeg1_annPoly
import Theorems.Thm_isBandDeg1_crePoly
import Theorems.Thm_isBandDeg1_momPoly
import Theorems.Thm_isBandDeg1_mulXPoly
import Theorems.Thm_isBandDeg4_ymPoly
import Theorems.Thm_isBandR1_annPoly
import Theorems.Thm_isBandR1_crePoly
import Theorems.Thm_isBandR1_momPoly
import Theorems.Thm_isBandR1_mulXPoly
import Theorems.Thm_isBandR4_ymPoly
import Theorems.Thm_isHermCol_diagCol
import Theorems.Thm_isHermCol_hopCol
import Theorems.Thm_isHermCol_numberCol
import Theorems.Thm_isHermCol_ymFockCol
import Theorems.Thm_isPosCol_numberCol
import Theorems.Thm_jacobiLagData_hFull
import Theorems.Thm_jacobiLag_secondOrder_eq_zero
import Theorems.Thm_kinetic_isSymmetricDom
import Theorems.Thm_krylovSpan_zero
import Theorems.Thm_lagrangianCore_symmetricOn
import Theorems.Thm_lowOrder_isSymmetricDom
import Theorems.Thm_momL_symmetric
import Theorems.Thm_mulOp_one
import Theorems.Thm_norm_X_mult_eq_one
import Theorems.Thm_norm_X_mult_list_eq_one
import Theorems.Thm_not_summable_inv_natCast_add_two
import Theorems.Thm_nsDiffH_eq_coreOp
import Theorems.Thm_nsDiffPoly_polySym
import Theorems.Thm_one_le_sqrt_succ
import Theorems.Thm_one_le_velMu
import Theorems.Thm_phi_zero
import Theorems.Thm_polySym_foPoly
import Theorems.Thm_polySym_momPoly
import Theorems.Thm_polySym_mulXPoly
import Theorems.Thm_posL_symmetric
import Theorems.Thm_qcdG2M4Row_lo
import Theorems.Thm_qcdG2M4_strongCoupling_consistent
import Theorems.Thm_raise_injective
import Theorems.Thm_rangeProj_isSelfAdjoint
import Theorems.Thm_richardson_qym_g4_gt
import Theorems.Thm_schurBound_hopCol
import Theorems.Thm_secHam_esa_core
import Theorems.Thm_secN_dom_dense
import Theorems.Thm_secondOrder_isSymmetricDom
import Theorems.Thm_sectorPart_inSector
import Theorems.Thm_shDiag_injective
import Theorems.Thm_shPair_injective
import Theorems.Thm_shRot_injective
import Theorems.Thm_shShear_injective
import Theorems.Thm_S_recip_random_zero
import Theorems.Thm_stoneU_mem_unitary
import Theorems.Thm_stoneU_surjective
import Theorems.Thm_support_annA
import Theorems.Thm_support_creA
import Theorems.Thm_swapVel_injective
import Theorems.Thm_tendsto_stoneU_zero
import Theorems.Thm_toLp_injective
import Theorems.Thm_up_injective
import Theorems.Thm_up_up_comm
import Theorems.Thm_velCore_dense
import Theorems.Thm_velCore_esa
import Theorems.Thm_velCore_symmetricOn
import Theorems.Thm_velH_symmetricOn
import Theorems.Thm_velMu_nonneg
import Theorems.Thm_viscous_isSymmetricDom
import Theorems.Thm_windowOfEquiv_exhausts
import Theorems.Thm_X_mult_zero
import Theorems.Thm_X_p_zero
import Theorems.Thm_ymAbelianPoly_eq_fqPoly
import Theorems.Thm_ymPoly_zero
import Theorems.Thm_yosidaGen_commute_resCLM
import Theorems.Thm_zeta_symm
